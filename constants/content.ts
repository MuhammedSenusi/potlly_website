...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    body:
      "The egusi is the closest thing to my mum's that I have found in the GTA. Pounded yam arrived still warm and wrapped properly.",
    kitchen: "Ada's Pot",
    kitchenId: "adas-pot",
  ...
  },
  {
    ...
    rating: 5,
    body:
      "Ordered small chops for 20 people. Everything arrived hot, counted correctly, and I just sent the e-Transfer at the door.",
    kitchen: "Nkechi's Small Chops",
    kitchenId: "nkechi-chops",
  ...
  },
  {
    ...
    rating: 4,
    body:
      "Proper ofada, wrapped in leaf, and the ayamase had real assorted meat in it. Delivery to Pickering was quick.",
    kitchen: "Ofada Republic",
    kitchenId: "ofada-republic",
