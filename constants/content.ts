 ...
 * The kitchens and cooks below are illustrative examples of the kind of listing
 * Pottly hosts — they are clearly-labelled sample content, not real vendors,
 * and no usage, revenue or scale claims are made anywhere on the site.
 */

export type Money = number;

/** Naira, formatted the way the mobile app formats it. */
...
export const kitchens: Kitchen[] = [
  {
    ...
    distanceKm: 1.2,
    deliveryFee: 800,
    deliveryArea: "Yaba, Akoka, Sabo and Ebute Metta",
    prepTime: "35–50 min",
    image: "/food/kitchen-mama-tayo.webp",
    alt: "A home kitchen counter with a large pot of stew on the stove",
    blurb:
      "Party jollof, efo riro and peppered chicken, cooked to order every morning. Bulk trays on Fridays.",
  ...
  },
  {
    ...
    distanceKm: 2.4,
    deliveryFee: 1000,
    deliveryArea: "Surulere, Ojuelegba and Costain",
    prepTime: "40–60 min",
  ...
  },
  {
    ...
    distanceKm: 3.8,
    deliveryFee: 1200,
    deliveryArea: "Ojota, Ogudu and Ketu",
    prepTime: "30–45 min",
    image: "/food/kitchen-halima.webp",
    alt: "Skewers of spiced grilled beef on a charcoal grill",
    blurb:
      "Charcoal suya, masa and tuwo, grilled fresh from 4pm. Order early on weekends.",
  ...
  },
  {
    ...
    distanceKm: 2.9,
    deliveryFee: 900,
    deliveryArea: "Gbagada, Anthony and Oworonshoki",
    prepTime: "45–70 min",
  ...
  },
  {
    ...
    distanceKm: 4.1,
    deliveryFee: 1500,
    deliveryArea: "Maryland, Ikeja GRA and Opebi",
  ...
  },
  {
    ...
    distanceKm: 6.3,
    deliveryFee: 1800,
    deliveryArea: "Lekki Phase 1, Ikate and Osapa",
    prepTime: "45–60 min",
